...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div >
        <div class="page-title">
            ...
            <a href="<%:Url.Action("edit","mastergiftcard") %>" class="btn btn-primary"><span class="icon fa fa-plus"></span> New</a>
            <div class="description">This is master of your giftcard. Manage here to show in your front end</div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="breadcumber" runat="server">
    <li>Dashboard</li>
    <li class="active">Master GiftCard</li>
</asp:Content>
