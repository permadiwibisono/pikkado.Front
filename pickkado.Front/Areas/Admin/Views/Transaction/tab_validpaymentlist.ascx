<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<dynamic>" %>                       
        ...
        <table class="datatable table table-striped fadeInUp animated" cellspacing="0" width="100%">
            ...
            <tbody>
                    <%foreach (var item in ViewBag.ValidPaymentList)
                        {%>
                        <tr>
        ...
        <div class="col-xs-12">
            ...
            <%--<ul class = "pager">                
                <li class = "previous  <%:PrevPage <= 0 ? "disabled" : "" %>"   ><a href="<%:PrevPage <= 0 ?"javascript:void(0)":"javascript:goToPage('#validpaymentlist .contentplaceholder','"+Url.Action("tab_validpaymentlist")+"','#validpaymentlist select',"+PrevPage+");"%>"  >&larr; Older</a></li>
                <li class = "next <%: PageCount<NextPage ? "disabled" : "" %>"><a href="<%:PageCount<NextPage ?"javascript:void(0)":"javascript:goToPage('#validpaymentlist .contentplaceholder','"+Url.Action("tab_validpaymentlist")+"','#validpaymentlist select',"+NextPage+");"%>">Newer &rarr;</a></li>
            </ul>--%>
        </div>