...
<div >
    <div class="page-title">
        ...
        <a href="<%:Url.Action("edit","masterpackage") %>" class="btn btn-primary"><span class="icon fa fa-plus"></span> New</a>
        <div class="description">This is master of your packages. Manage here to show in your front end</div>
            ...
            <div class="card">                
                ...
                <div class="card-body">
                    <table class="datatable table table-striped" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <%if(((List<pickkado.Entities.Package>)ViewBag.List).Count>0){ %>
                            <%foreach (var i in (List<pickkado.Entities.Package>)ViewBag.List)
                              {%>
                          ...
                          <tr>
                            ...
                            <td><%:i.UpdatedDate %></td>
                            <td>
                                <a href="<%:Url.Action("edit","masterpackage",new{id=i.Id}) %>" class="btn btn-primary"><span class="icon fa fa-edit"></span> Edit</a>
                            </td>
                            <%using (Html.BeginForm("delete", "masterpackage", new { id = i.Id }, FormMethod.Post, new {id="F"+i.Id }))
                              {%>
...
<asp:Content ID="Content3" ContentPlaceHolderID="breadcumber" runat="server">
   <li >Dashboard</li>
   <li class="active">Master Packages</li>
</asp:Content>
