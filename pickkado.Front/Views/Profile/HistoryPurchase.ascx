...
<div style="padding: 50px; margin-left: 120px">
    <div class="container-fluid title-underline">
        <span class="font-avant" style="font-size: 15px">Sejarah Pembelian
        </span>
    </div>
    <%var userLogin = (pickkado.Entities.User)TempData["UserLogin"]; %>
    <%var historyModel = Model.Where(a => (a.Status == pickkado.Front.TransactionStatus.CompletedAdmin ||
                            a.Status == pickkado.Front.TransactionStatus.CompletedUser ||
                            a.Status == pickkado.Front.TransactionStatus.Cancel) &&
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="padding: 15px 15px 15px 0px; width:200px">
                                    <button id="Button2" type="button" class="btn btn-default btn-lg btn-block btn-login" onclick="detailPatungan_onClick('<%:m.Id %>')">Detail Patungan </button> 
                                </td>
                                <td style="padding: 15px 0px 15px 0px; width:200px">
                                    <button id="Button3" type="button" class="btn btn-default btn-lg btn-block btn-login" onclick="detailGiftcard_onClick('<%:m.Id %>')">Detail Giftcard </button> 
                                </td>
                                <%} %>
                            </tr>
                        </table>
